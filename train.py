...
if __name__ == "__main__":
    ...
    parser.add_argument("--weight_tying", default=1, type=int)
    parser.add_argument("--dim_att", default=0, type=int)
    parser.add_argument("--dim_ffn", default=0, type=int)
    parser.add_argument("--nncp_data", default=0, type=int)
...
"""
    ...
    if args.nncp_data == True:
        train_data = MyDataset_NNCP(args)
    args.vocab_size = train_data.vocab_size

    from src.training.model import RWKV
    
    if args.weight_tying:
        rank_zero_info(f"########## Tying embedding weights and head weights ##########")
    model = RWKV(args)
